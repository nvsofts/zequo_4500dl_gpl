...
include $(TOPDIR)/../../config/project.mk

ifeq ($(PROJECT_MAGIC),)
$(error ERROR! ROL project magic is missing, check project.mk file)
endif
...
ROL_CFLAGS = -DMV_ROL_PROJECT_MAGIC=$(PROJECT_MAGIC)
ALL_CFLAGS += $(EXTRA_CPPFLAGS) $(ROL_CFLAGS)
