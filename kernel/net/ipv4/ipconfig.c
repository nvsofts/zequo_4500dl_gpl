...
#if defined CONFIG_MV_SET_LINK_DOWN_DELAY
#define CONF_CARRIER_TIMEOUT   CONFIG_MV_SET_LINK_DOWN_DELAY
#else
#define CONF_CARRIER_TIMEOUT   3000  /* Wait for carrier timeout */
#endif
