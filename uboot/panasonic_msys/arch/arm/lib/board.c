...
typedef int MV_BOOL;
#endif
extern MV_BOOL mvUartSetSilent(MV_BOOL silent);
#endif
extern void project_axp_specific_init(void);
extern void project_msys_specific_init(void);
extern MV_BOOL isBoardMsys(void);
...
# endif
	...
	if (isBoardMsys())
		project_msys_specific_init();
	else
		project_axp_specific_init();
