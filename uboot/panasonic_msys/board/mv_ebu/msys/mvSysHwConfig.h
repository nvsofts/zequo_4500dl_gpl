...
#define PEX0_MEM_SIZE_AXP		_32M
#define PEX0_MEM_SIZE_MSYS		_128M
#define PEX0_MEM_SIZE			(isBoardMsys()? PEX0_MEM_SIZE_MSYS: PEX0_MEM_SIZE_AXP)
...
#define SWITCH_REGS_BASE_REMOTE_PP		0xE4000000  
...
#define MSYS_WIN_MAP_TBL {									\
		...
		{ { PEX0_MEM_BASE,        0,      PEX0_MEM_SIZE_MSYS },      0,              EN },         /*  8 PEX0_MEM */	\
...
#define AXP_WIN_MAP_TBL {									\
	...
	{{PEX0_MEM_BASE,	0,	PEX0_MEM_SIZE_AXP },	0,			EN},	/* PEX0_MEM */  \
